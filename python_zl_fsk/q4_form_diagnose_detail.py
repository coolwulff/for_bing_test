...
def get_temp_data():
    ...
    mysql = db_pymysql(host=host_56
                         ...
                         ,charset='utf8')
    sql_temp = "select * from form_diagnose_detail_temp;"
...
def get_current_data():
     ...
     mysql = db_pymysql(host=host_56
                         ...
                         ,database=database_56
                         ,charset='utf8')
     sql_curr = "select * from form_diagnose_detail where hospital_code = '42502657200';"
...
def preprocess(da):
    ...
    zd = ['empi', 'patient_no','inpatient_number','encounter_id','diagnose_code']
...
type,
    ...
    for i in range(len(data)):
        ...
        type1 = 1
        diagnose_time = data['diagnose_time'][i]
        diagnose_time_var = data['diagnose_time_var'][i]
    ...
    sql = '''
    insert into form_diagnose_detail(
                empi, 
                patient_no,
                encounter_id,
                patient_name,
...
def insert_data2mysql_4(is_clear_temp = False): 
...
#    a,b = insert_data2mysql_4()
#    #df_temp = get_temp_data()
#    da = df_temp.copy()
#    a = preprocess(df_temp)
    a = compare_data()