# -*- coding: utf-8 -*-
"""
Created on Thu Jul 14 14:53:08 2022
...
def get_temp_data():
    ...
    mysql = db_pymysql(host=host_56
                         ...
                         ,charset='utf8')
    sql_temp = "select * from form_complaint_inhos_temp;"
...
def get_current_data():
     ...
     mysql = db_pymysql(host=host_56
                         ...
                         ,database=database_56
                         ,charset='utf8')
     sql_curr = "select * from form_complaint_inhos where hospital_code = '42502657200';"
...
def generate_input(data):
    ...
    sql = '''
    insert into form_complaint_inhos(
                    empi,
                    patient_no,
                    patient_name,
                    id_number,
                    ...
                    create_date,
                    hospital_code,
                    delete_flag ) values (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s);
    '''
    return sql, d_insert
...
def insert_data2mysql_16(is_clear_temp = False): 
